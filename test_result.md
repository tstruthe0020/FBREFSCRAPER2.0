...
agent_communication:
  ...
  - agent: "main"
    message: "CRITICAL ISSUES DOCUMENTED: Created comprehensive documentation of match report scraping shortcomings. BLOCKING ISSUES IDENTIFIED: 1) Browser session disconnection during long scraping (Page.goto: Target page closed), 2) Unknown FBref match report HTML structure (current selectors unvalidated), 3) Zero data successfully stored despite finding 380+ fixtures. COMPREHENSIVE TODO CREATED: /docs/TODO-match-report-scraping.md with prioritized tasks, /docs/README.md updated with current status, /app/CURRENT-ISSUES.md for quick reference. NEXT CRITICAL STEPS: Single match HTML analysis, session recovery implementation, real data extraction validation."